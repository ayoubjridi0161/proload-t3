...
export default function Post({userImage,userName,userId,postContent,media,likes,liked,id,comments,time,appUser}: Props) {
  ...
  return (
    <div className={ `p-5 mt-4 space-y-4 bg-white/70` }>
        ...
        <div className=' flex justify-between items-center '>
          ...
          <div className='cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-105 space-x-1 '>
