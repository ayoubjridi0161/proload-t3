    ...
    <div className="container mx-auto py-8">
      <div className="animate-pulse">
        ...
        <div className="relative h-auto min-h-[180px] md:min-h-[250px] lg:min-h-[300px] mb-6">
          <div className="absolute inset-0 h-3/4 bg-gray-300 rounded"></div>
          <div className="relative pt-[15%] md:pt-[12%] px-4 pb-4 flex flex-col sm:flex-row items-center sm:items-end gap-4 z-10">
            <div className='w-20 h-20 sm:w-28 sm:h-28 md:w-36 md:h-36 bg-gray-400 rounded-full border-4 border-white shadow-md'></div>
        ...
        <div className='h-px bg-gray-300 mt-3 mb-3'></div>
